<template>
    <div class="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg">
        ...
        <div class="flex items-center px-6 py-3 bg-gray-900">
            <svg aria-label="headphones icon" class="w-6 h-6 text-white fill-current" viewBox="0 0 24 24" fill="none"
            ...
            <h1 class="mx-3 text-lg font-semibold text-white">{{props.user.username}}</h1>
        </div>
        ...
        <div class="px-6 py-4">
            ...
            <div class="flex items-center mt-4 text-gray-700">
                ...
                <h1 class="px-2 text-sm">{{props.user.homeTown}}</h1>
            </div>
